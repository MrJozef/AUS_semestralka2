...
namespace structures
{
	...
	{
		//kontrola indexu [toto je vsak uz v mapovacej funkcie]
		//na ktorom byte vo vektore zacina udaj ktory hladam - mapovacia funkcia!!! (funkcia ktora transf. index v poli transformuje na index vo vector)
		//getBytePointer()
		//pretypovat byte* na T*
	...
	{
		//to iste ako hore, ale setrivo napisane
	...
	{
		//velkost pola nemusim kontrolovat, lebo vector to vie sam zisit -> 2polia sa rovnaju ak sa rovnaju ich vektory
	...
	{
		if (length > 0) {//tato podmienka je nepotrebna, lebo ju mam vo vektore
